...
export const moviesRecommendationReducer = (state = {movie: []}, action) => {
  switch (action.type) {
    case moviesConstants.MOVIES_RECOMMENDATION_REQUEST:
      return { isLoading: true };
    case moviesConstants.MOVIES_RECOMMENDATION_SUCCESS:
      return { isLoading: false, movies: action.payload };
    case moviesConstants.MOVIES_RECOMMENDATION_FAIL:
      return { isLoading: false, isError: action.payload };
    default:
      return state;
  }
